...
use \PHPSpec\Specification\CustomMatcher;
...
class DescribeCustomMatcher extends \PHPSpec\Context
{
  function itCallsTheCustomMatcherForSuccessfulShould() {
    ...
    })->should->throwException("Spec\PHPSpec\Specification\ExampleCustomMatcherMatchSuccessful");
  }
  ...
  function itCallsTheCustomMatcherForUnsuccessfulShould() {
    ...
    })->should->throwException("Spec\PHPSpec\Specification\ExampleCustomMatcherMatchFailed");
  }
}
