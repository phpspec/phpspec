Feature: Developer generates a method
  ...
  Scenario: Generating a method with an array containing two variables with different types
    ...
    Then the class in "src/CodeGeneration/MethodExample9/Markdown.php" should contain:
      ...
      """
  Scenario: Generating a method with an array containing more than two variables with different types
    Given the spec file "spec/CodeGeneration/MethodExample10/MarkdownSpec.php" contains:
      """
      <?php

      namespace spec\CodeGeneration\MethodExample10;
      ...
      class MarkdownSpec extends ObjectBehavior
      {
          function it_converts_an_array_of_plain_text_to_html_paragraphs()
          {
              $this->toHtml(array('Hi, there', 2, true))->shouldReturn('<p>Hi, there</p><p>2</p><p>true</p>');
          }
      }

      """
    And the class file "src/CodeGeneration/MethodExample10/Markdown.php" contains:
      """
      <?php

      namespace CodeGeneration\MethodExample10;
      ...
      """
    When I run phpspec and answer "y" when asked if I want to generate the code
    Then the class in "src/CodeGeneration/MethodExample10/Markdown.php" should contain:
      """
      <?php
