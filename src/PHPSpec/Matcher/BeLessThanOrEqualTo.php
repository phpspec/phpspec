...
class BeLessThanOrEqualTo implements Matcher
{
    ...
    /**
     * Checks whether actual value is lesser than or equal to the given number
     * 
     * @param mixed $actual
     * @return boolean
     */
    ...
    {
        return 'expected less than or equal to ' .
               var_export($this->_expected, true) . ', got ' .
               var_export($this->_actual, true) .
               ' (using beLessThanOrEqualTo())';
    }
