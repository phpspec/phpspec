...
class BeLessThan implements Matcher
{
    ...
    /**
     * Checks whether actual value is lesser than the given number
     * 
     * @param mixed $actual
     * @return boolean
     */
    ...
    {
        return 'expected less than ' . var_export($this->_expected, true) .
    ...
    public function getNegativeFailureMessage()
    {
        return 'expected ' . var_export($this->_actual, true) .
               ' not to be less than ' . var_export($this->_expected, true) .
               ' (using beLessThan())';
    }
