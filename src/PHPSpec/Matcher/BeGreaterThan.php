 ...
 * @license    http://www.gnu.org/licenses/lgpl-3.0.txt GNU Lesser General Public Licence Version 3
 */
class BeGreaterThan implements Matcher
{
    ...
    /**
     * Checks whether actual value is greater than the given number
     * 
     * @param mixed $actual
     * @return boolean
     */
    ...
    {
        return 'expected greater than ' . var_export($this->_expected, true) .
    ...
    public function getNegativeFailureMessage()
    {
        return 'expected ' . var_export($this->_actual, true) .
               ' not to be greater than ' . var_export($this->_expected, true) .
               ' (using beGreaterThan())';
    }
