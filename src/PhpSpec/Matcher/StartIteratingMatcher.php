...
final class StartIteratingMatcher implements Matcher
{
    /**
     * @var Presenter
     */
    ...
    public function positiveMatch($name, $subject, array $arguments)
    {
        try {
            ...
            throw new FailureException('Expected subject to have the same or more elements than matched value, but it has less.', 0, $exception);
